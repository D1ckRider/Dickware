...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    if (*v)
    {
		...
		window->DrawList->AddRectFilled(check_bb.Min + ImVec2(pad, pad), check_bb.Max - ImVec2(pad, pad), GetColorU32(ImGuiCol_CheckMark), style.FrameRounding); // Main gradient.
    }
